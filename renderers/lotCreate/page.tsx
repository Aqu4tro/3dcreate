...
export function walls({
  ...
  walls.push({
    x: 0,
    y: height / 2 - (topSize - tickLot) / 2 + angle_Top.f * 4.35,
    z: -length / 2 + sizePin,
    H: height - (topSize + tickLot) + angle_Top.f * 8.7,
    W: width,
    L: size,
    N: "F",
  });
  walls.push({
    x: 0,
    y: height / 2 - (topSize - tickLot) / 2 + angle_Top.b * 4.35,
    z: length / 2 - sizePin,
    H: height - (topSize + tickLot) + angle_Top.b * 8.7,
    W: width,
    L: size,
    N: "B",
  });
  walls.push({
    x: width / 2 - sizePin,
    y: height / 2 - (topSize - tickLot) / 2 + angle_Top.l * 4.35,
    z: 0,
    H: height - (topSize + tickLot) + angle_Top.l * 8.7,
    W: size,
    L: length,
    N: "R",
  });
  walls.push({
    x: -width / 2 + sizePin,
    y: height / 2 - (topSize - tickLot) / 2 + angle_Top.r * 4.35,
    z: 0,
    H: height - (topSize + tickLot) + angle_Top.r * 8.7,
    W: size,
    L: length,
    N: "L",
  });
