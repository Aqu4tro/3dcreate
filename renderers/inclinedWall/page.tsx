      ...
      vertices = new Float32Array(
        angle_Top.b
          ? [
              ...
              length / 2 - size / 2,
              -size / 2,
              (length + size) * Math.tan(angle_Top.b) + height / 2,
              length / 2 - size / 2,
              -size / 2,
              height / 2,
              -length / 2 - size / 2,
          ...
          ? [
              ...
              length / 2 + size / 2,
              -size / 2,
              (length + size) * Math.tan(angle_Top.f) + height / 2,
              -length / 2 + size / 2,
              -size / 2,
              height / 2,
              -length / 2 + size / 2,
      ...
      vertices_2 = new Float32Array(
        angle_Top.b
          ...
          ? [
              ...
              -length / 2 + size / 2,
              size / 2,
              height / 2 + (length + size) * Math.tan(angle_Top.f),
              -length / 2 + size / 2,
              size / 2,
              height / 2,
              length / 2 + size / 2,
    ...
    case "F":
      vertices = new Float32Array(
        angle_Top.r
          ? [
              -width / 2 + size,
              width * Math.tan(angle_Top.r) + height / 2,
              -size / 2,
              width / 2,
              height / 2,
              -size / 2,
          ...
          ? [
              ...
              -size / 2,
              width / 2 - size,
              width * Math.tan(angle_Top.l) + height / 2,
              -size / 2,
              width / 2 - size,
              height / 2,
              -size / 2,
    ...
    <mesh>
      <mesh>
        ...
        <meshStandardMaterial
          map={_wallTexture instanceof THREE.Texture ? _wallTexture : null}
        />
      </mesh>
      <mesh>
        <bufferGeometry>
      ...
      <Plane
        args={[
          angle_Top.r || angle_Top.l
            ? width / Math.cos(angle_Top.l || angle_Top.r)
            : size,
        ...
        position={[
          0,
          height / 2 +
            ((length * Math.tan(angle_Top.f)) / 2 ||
              (length * Math.tan(angle_Top.b)) / 2 ||
              (width * Math.tan(angle_Top.r)) / 2 ||
              (width * Math.tan(angle_Top.l)) / 2),
